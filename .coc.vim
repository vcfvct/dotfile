let g:coc_global_extensions = ['coc-json', 'coc-tsserver', 'coc-eslint', 'coc-pairs', 'coc-git', 'coc-css', 'coc-html', 'coc-jest', 'coc-java', 'coc-spell-checker', 'coc-tabnine', 'coc-explorer', 'coc-yank', 'coc-smartf', 'coc-docthis', 'coc-pyright']
